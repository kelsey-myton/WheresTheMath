...
class Lesson1 extends Component {
  ...
  render(){
    ...
    <div className="content">
      ...
      <div className="subcontentMock2">

        <div className="column1Mock2">
        RECIPE<h1 id="So">So you want to Bake?</h1>
          <img src={require("./images/image1.jpg")}/>
          Ready in <strong>20 minutes</strong><br/>
          Serves <strong>1 baker</strong>
          <ol id="OL">
          <li>2.Time to Decorate!  3 of your friends want chocolate frosting, 2 want vanilla with sprinkles, you and 4 others want red velvet and 2 of those friends want sprinkles.</li><br/>
          <li>4.Each tube of frosting serves 10 cake pops, what percent of the tubes will you use for each?</li>
          </ol>
        </div>

        <div className="column2Mock2">
          ...
          <h1>Preparation</h1>
          <ol id="OL">
          <li>1. Baking is a fun pass time for a rainy day or for a summer pool party You want to bake cake pops for a July 4th celebration.How many people are coming? What do you need to get started?</li><br/>
          <li>3.The directions on the box of cake mix clearly direct you to make the cake and the cake has been cooled. This box made 30 cake pops.</li> <br/>
          ...
          <li>
          <h1>Tips</h1>
          <p id="ptagMock2">Create the graph using Desmos and write down all the facts you know</p>
          </li>
          </ol>

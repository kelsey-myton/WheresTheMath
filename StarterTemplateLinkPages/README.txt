...
any old set-up I want plus I have some testing backend stuff going on with App.js. These are just the "src" files to look at for reference. You'll likely need to install reactstrap and some other stuff but it will tell you if it fails to compile.
